...
fun ErrorMessageComponent(message: String, modifier: Modifier) {
    Column(modifier = modifier.testTag(TestTags.ERROR_MESSAGE), horizontalAlignment = androidx.compose.ui.Alignment.CenterHorizontally) {
        ...
        Text(
            ...
            modifier = Modifier
                .padding(16.dp)
                .testTag(TestTags.ERROR_MESSAGE_TEXT),
